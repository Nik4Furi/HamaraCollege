...
<div id="sign col">
    <h1 class="h-primary" style="text-align:center">You add the <sapn class="mark"><?php echo $candidate?></sapn> </h1>
    <form method="post" id="form" class="form" >
        <div class="inputs">
            <label for="name">Enter Name of  <?php echo $candidate?></label>
            <input type="text" name="name" id="name" required autocomplete="none" autofocus>
        </div>

        <div class="inputs">
            <label for="semester">Enter Semester of <?php echo $candidate_relation?></label>
        ...
        <div class="inputs">
            <label for="branch">Enter Branch of <?php echo $candidate_relation?></label>
        ...
        <div class="inputs">
            <label for="email">Enter Email of <?php echo $candidate?></label>
            <input type="email" name="email" id="email" required autocomplete="none">
        </div>
        <div class="inputs">
            <label for="clgid">Enter ClgID/Username of <?php echo $candidate_relation?></label>
            <input type="text" name="clgid" id="clgid" required autocomplete="none">
        </div>
        <div class="inputs">
            <label for="password">Enter Password of <?php echo $candidate?>t</label>
            <input type="password" name="password" id="password" required autocomplete="none">
        </div>
        
        <button class="btn" name="add" type="submit" id="add" >Add <?php echo $candidate?> </button>
    ...
    // echo "Can you inserted the db<br>";
     ...
     if (isset($_POST['add'])) {
        ...
        $sql = "insert into addstudent(name, semester, branch, email, clgid, password) values('$name','$semester','$branch','$email','$clgid','$password')";
