...
<section class="about-container col">
    ...
    <div class="row container-fluid about-section ">
        ...
        <div class="right col" style="margin: 7px 5px;">
            ...
            <p class="para">Hello Everyone, we know that <span class="mark">only a jeweler can find diamonds.</span>So
                we are the diamonds and our mentor(<span class="mark">Jyoti Gajrani</span>) is a jeweler , she is
                encourge or guide our teem to find the better way to create this website or mangament system.</p>
            <p class="para">She is phd in the computer science from the IIT Jodhpur and she is very honest with her
                work, she is also motivate and guide the students about their career</p>
                ...
                <div class="swiper-slide row container-fluid" style="width: 100%;">
                    ...
                    <div class=" card  col media-w">
                        ...
                        <div class="h-para col">
                            ...
                            <h3 class="h-ternary">B.tech 2 <sup>nd</sup>Year, Computer Science</h3>
                            <p class="para">He is work as a <span class="mark">Team Leader</span> who is manage the web
                                and Execute any plan.</p>
                ...
                <div class="swiper-slide row container-fluid" style="width: 100%;">
                    <div class=" card  col media-w">
                        ...
                        <div class="h-para col">
                            ...
                            <p class="para-sm">His work as motivator and guider because of motivate us everytime about
                                this web.
                            </p>
                        </div>
                    </div>
                    <div class="card col media-w">
                        <div class="box" style="width: 19%;border: none;">
                            <img src="./static/img/about/dev-3.jpg" class="w-100" alt="developer"
                        ...
                        <div class="h-para col">
                            ...
                            <p class="para-sm">He is just like a helper for help some small works just as take water,
                                take tea etc.
                            </p>
                        </div>
                    </div>
