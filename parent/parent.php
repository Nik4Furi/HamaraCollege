...
//  All dashboard contents  
 $dashboard_title_first_content = ' <h1 class="h-primary">Your son <span class="mark">performance</span> or <span class="mark">
...
<div class="student-dashboard-container ">
 <div class="box-skill row">
     ...
     <div class="h-para">
         <h3 class="h-ternary">Your son completed the workshop Faithfully and get good results </h3>
         <div class="range">
 ...
 <div class="box-skill row">
     ...
     <div class="h-para">
         <h3 class="h-ternary">Your son solved the software problems </h3>
         <div class="range">
 ...
 <div class="box-skill row">
     ...
     <div class="h-para">
         <h3 class="h-ternary">Your son create the webs </h3>
         <div class="range">
...
$dashboard_title_second_content = '  <h1 class="h-primary">Your son <span class="mark">result</span> are here see your performance in the Semesters exams!</h1>
<!-- your result are here  -->
<div class="h-primary">
  <canvas id="myChart"></canvas>
</div>';

 require ('../includes/userDashboard.php');
?>
